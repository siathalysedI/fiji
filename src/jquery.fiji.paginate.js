...
(function($, undefined) {
	...
	$.widget("fiji.paginate", {
		...
		_render: function () {
			...
			self.element.find('.fiji-paginate-previous').attr('href', prevHref);
			var nextHref = self.element.find('a[rel~="next"]').attr('href');
			self.element.find('.fiji-paginate-next').attr('href', nextHref);
		},
